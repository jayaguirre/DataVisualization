 ...
 * @file volren.js
 * @date 4/19/2021
 * @summary This file provides the functions to create the vtk.js volume renderer canvas as well as to update its transfer functions.
 *
 * Volume Renderer for CSC444 Assignment 11
 * It expects a div with id 'tfunc' to place the d3 transfer function editor
 */
 ...
 *
 * This function reads the contents of a .vti file and initializes a volume renderer.  The base
 * transfer function is empty.
 *
 * @param fileContents
 */
function initializeVR(fileContents) {
	console.log('initializeVR');
    ...
    let image = reader.getOutputData();
 ...
 *
 * This function reads a list of color and opacity control points for the transfer function.
 *
 * The optional third parameter "categorical" is used to specify whether or not the color transfer
 * function should be interpreted as categorical.  When it is undefined or set to false, it will
 * disable discrete transfer functions, but when set to true it will disable interpolation.
 *
 * @param colorPts
 * @param opacityPts
 * @param categorical
